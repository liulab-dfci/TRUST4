...
TRUST4 depends on [pthreads](http://en.wikipedia.org/wiki/POSIX_Threads) and samtools depends on [zlib](http://en.wikipedia.org/wiki/Zlib). TRUST4 can be successfully compiled with gcc_darwin17.7.0 and gcc_9.2.0 installed by Homebrew on MacOS.
